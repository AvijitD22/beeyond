...
export default function AvailableOrders() {
  ...
  if (loading) return <div style={{ padding: '40px', textAlign: 'center' }}>Loading available orders...</div>;
    ...
    <div style={{ padding: '20px', maxWidth: '1100px', margin: '0 auto' }}>
      ...
      {orders.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 20px', background: '#f8f9fa', borderRadius: '8px' }}>
          ...
          <p>New orders will appear here automatically (refresh or wait for real-time later)</p>
        </div>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          {orders.map((order) => (
            ...
            >
              ...
              <div style={{ borderTop: '1px solid #eee', paddingTop: '16px', marginTop: '16px', fontWeight: 'bold' }}>
